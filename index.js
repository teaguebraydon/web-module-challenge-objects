...
console.log(createMenuItem('Enchaladas', 10, 'Dinner'))
...
function addReview(array, name, rating, feedback) {
  let obj = {name: name, rating: rating, feedback: feedback};
  array.push(obj);
  return array;  
}

console.log(addReview(reviews, 'James', 4, `This place was amazing, would definitely recommend!`));
